...
- Theme ZIP: `MultiRent-0.1.15.zip`
- Plugin ZIP: `multirent-companion-0.1.15.zip`
...
- `MultiRent-0.1.15.zip`
- `multirent-companion-0.1.15.zip`

If you received `multirent-template-0.1.15.zip`, unzip it first. It contains the separate theme and plugin ZIP files.
...
3. Choose `multirent-companion-0.1.15.zip`.
4. Click **Install Now**.
