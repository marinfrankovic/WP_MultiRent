...
- Theme ZIP: `MultiRent-0.1.14.zip`
- Plugin ZIP: `multirent-companion-0.1.14.zip`
...
- `MultiRent-0.1.14.zip`
- `multirent-companion-0.1.14.zip`

If you received `multirent-template-0.1.14.zip`, unzip it first. It contains the separate theme and plugin ZIP files.
...
3. Choose `multirent-companion-0.1.14.zip`.
4. Click **Install Now**.
