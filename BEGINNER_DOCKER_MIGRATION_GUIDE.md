...
- Theme ZIP: `multirent-theme-upload-0.1.23.zip`
- Plugin ZIP: `multirent-companion-plugin-upload-0.1.23.zip`
...
- `multirent-theme-upload-0.1.23.zip`
- `multirent-companion-plugin-upload-0.1.23.zip`

If you received `multirent-complete-package-extract-first-0.1.23.zip`, unzip it first. It contains the separate theme and plugin ZIP files.

Important: do not upload `multirent-complete-package-extract-first-0.1.23.zip` or GitHub's automatic source-code ZIP directly as a theme. If WordPress says the theme is missing `style.css`, you selected the wrong ZIP. Choose `multirent-theme-upload-0.1.23.zip` for the theme installer.
...
4. Choose `multirent-theme-upload-0.1.23.zip`.
5. Click **Install Now**.
6. Click **Activate**.
...
3. Choose `multirent-companion-plugin-upload-0.1.23.zip`.
4. Click **Install Now**.
