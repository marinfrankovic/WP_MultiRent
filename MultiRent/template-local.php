<?php
/**
 * Template Name: Local Information
 *
 * @package MultiRent
 */
...
<main id="primary" class="site-main">
	<?php while ( have_posts() ) : ?>
		...
		<section class="section local-section">
			<div class="container local-page-layout">
				...
				<?php if ( '1' === (string) multirent_display_option( 'show_local_links', '1' ) && $local_links ) : ?>
					<aside class="local-links-panel">
						...
						<p><?php esc_html_e( 'Add buses, flights, ferries, local guides, restaurants, or any helpful links for guests.', 'multirent' ); ?></p>
