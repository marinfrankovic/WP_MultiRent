<?php
/**
 * Template Name: Contact - Split Map
 *
 * @package MultiRent
 */
...
<main id="primary" class="site-main">
	<?php while ( have_posts() ) : ?>
		...
		<section class="section contact-section contact-template-split">
			<div class="container">
				<?php if ( '1' === (string) multirent_display_option( 'show_contact_map', '1' ) && $map_query ) : ?>
					<div class="contact-map-card contact-map-feature">
				...
				<div class="contact-layout contact-layout-reversed">
