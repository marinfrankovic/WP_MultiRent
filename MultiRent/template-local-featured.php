<?php
/**
 * Template Name: Local - Featured Guide
 *
 * @package MultiRent
 */
...
<main id="primary" class="site-main">
	<?php while ( have_posts() ) : ?>
		...
		<section class="section local-section local-template-featured">
			<div class="container">
				<?php if ( '1' === (string) multirent_display_option( 'show_local_guides', '1' ) && $local_guides ) : ?>
					<section class="local-guide-panel local-guide-featured-panel">
				...
				<div class="local-page-layout local-page-layout-featured">
					<div class="local-main-column">
