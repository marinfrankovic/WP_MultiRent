...
- `multirent-companion/`: companion plugin for setup screens, rental units, amenities, menus, colors, starter content, and in-admin help.
...
6. On a fresh site, use **Create Starter Pages, Menu, and Amenities**.
7. Add or edit rental units under **MultiRent Setup > Rental Units**.

If you received `multirent-complete-package-extract-first-0.1.31.zip`, extract it first. It contains the separate theme and plugin ZIP files that must be uploaded individually.
